...
import com.univercode.getfast.models.dtos.ValidationErrorDTO;
...
public class ControllerExceptionHandler {
    ...
    public ResponseEntity<CustomErrorDTO> methodArgumentValidation(MethodArgumentNotValidException e, HttpServletRequest request) {
